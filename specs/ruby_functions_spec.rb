...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    volume_1 = volume_of_cube( 2 )
    volume_2 = volume_of_cube( 3 )
    assert_equal( 8 , volume_1)
    assert_equal( 27 , volume_2)
    #add test code here
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_1 = volume_of_sphere( 2 )
    volume_2 = volume_of_sphere( 3 )
    assert_equal( (4/3 * Math::PI * 8), volume_1 )
    assert_equal( (4/3 * Math::PI * 27), volume_2 )
    #add test code here
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    celsius_1 = farenheit_to_celsius( 70 )
    celsius_2 = farenheit_to_celsius( 100 )
    assert_equal( 21, celsius_1)
    assert_equal( 37, celsius_2)
